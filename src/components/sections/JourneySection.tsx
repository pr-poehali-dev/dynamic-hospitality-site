...
const JourneySection = () => {
  ...
  const timeline = [
    ...
    },
    {
      ...
      fullDesc: 'Начинала с линейных позиций: официантка, хостес, бармен. Росла внутри компаний, понимая бизнес на всех уровнях. От официанта до куратора закрытого клуба в Москве, аналогов которому нет.',
