  ...
  const guarantees = [
    {
      ...
      description: '15 лет в HoReCa на всех стадиях: запуски с нуля, ребрендинги, популярные рестораны. VIP-сервис в Marriott, Radisson, Four Seasons. Закрытые мероприятия с первыми лицами государства.',
      highlight: 'Я знаю HoReCa изнутри — от кухни до VIP-залов. Не теоретик из учебников, а практик с руками в тесте.',
    ...
    },
    {
      ...
      highlight: 'За весь период работы ни разу не возвращала. Потому что система работает.',
      fact: '0 возвратов',
