  ...
  const faqCategories = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 'Гарантирую конкретные показатели: рост среднего чека на 20-30%, увеличение выручки на 30-50% в течение первого месяца. Но есть важное условие — результат возможен только при полном внедрении всех рекомендаций и выполнении задач. Если вы готовы применять на практике всё, чему обучу команду, успех гарантирован. Я работаю на ваш результат, а вы — на его закрепление!'
        }
      ]
    },
    {
