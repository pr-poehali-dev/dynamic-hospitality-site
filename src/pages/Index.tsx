...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <MarqueeText 
        text={[
          '📝 Как я увеличила средний чек на 40% за месяц',
          '🎯 5 ошибок официантов, которые убивают продажи',
          '💡 Секрет допродажи: техника "тройного предложения"',
          '🔥 Почему гости не возвращаются второй раз?',
          '⚡ Интенсив «7 дней»: как это работает',
          '💰 Кейс: +5 млн к выручке без рекламы',
          '🎓 Топ-3 навыка успешного управляющего',
          '🍷 Винная карта как инструмент продаж'
        ]} 
        speed="slow"
      />
      <FooterSection />
